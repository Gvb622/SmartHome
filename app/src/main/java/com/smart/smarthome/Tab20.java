    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AddItem2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent5 = new Intent(Tab20.this, SelectItemShop.class);
                    ...
                    public boolean onItemClick(View view, int position) {
                                            ...
                                            builder.setItems(priceItem, new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialog, int which) {
                                                    ...
                                                    if (which == 0) {
                                                        ...
                                                        Toast.makeText(Tab20.this, i.getName() + " Already add to inventory ", Toast.LENGTH_LONG).show();
                        ...
                        */
                            ...
                            s.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    Shoplistitem Shopitem = dataSnapshot.getValue(Shoplistitem.class);
                                    final AlertDialog.Builder builder2 = new AlertDialog.Builder(Tab20.this);
                            ...
                            if (placeLikelihoodList != null) {
                                for (int i = 0; i < 10 && i < placeLikelihoodList.size(); i++) {
                                    ...
                                    if(p.getPlace().getPlaceTypes().contains(43)){
                                        Toast.makeText(Tab20.this,p.getPlace().getName() + "  " +  "Supermarket near you", Toast.LENGTH_SHORT).show();
                                        break;
                                    }else{
                                        Toast.makeText(Tab20.this,"No supermarket nearby", Toast.LENGTH_SHORT).show();
                                    }
