...
public class Tab17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(Tab17.this)
        ...
        final DatabaseReference fac = FirebaseDatabase.getInstance().getReference().child("users").child(user.getUid()).child("shoppinglist").child("Beverage and Drink Powder");
        fac.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mDatabase = FirebaseDatabase.getInstance().getReference().child("users").child(user.getUid()).child("shoppinglist").child("Beverage and Drink Powder");
            ...
            protected void populateViewHolder(ItemViewHolder viewHolder, final Shoplistitem model, final int position) {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                User.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        ...
                                        final AlertDialog.Builder builder = new AlertDialog.Builder(Tab17.this);
                                        ...
                                        builder.setItems(priceItem, new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialogInterface, int which) {
                                                ...
                                                if(which == 0){
                                                    ...
                                                    AlertDialog.Builder builder3 = new AlertDialog.Builder(Tab17.this);
                                                    builder3.setTitle("How much price that you buy ?");
                                                    final EditText input = new EditText(Tab17.this);
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        AlertDialog.Builder builder5 = new AlertDialog.Builder(Tab17.this);
