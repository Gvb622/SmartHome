...
public class Tab19 extends AppCompatActivity {
   ...
   Double Volum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference fac = FirebaseDatabase.getInstance().getReference().child("users").child(user.getUid()).child("shoppinglist").child("Household Product");
        fac.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mDatabase = FirebaseDatabase.getInstance().getReference().child("users").child(user.getUid()).child("shoppinglist").child("Household Product");
            ...
            protected void populateViewHolder(ItemViewHolder viewHolder, final Shoplistitem model, final int position) {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                User.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        ...
                                        final AlertDialog.Builder builder = new AlertDialog.Builder(Tab19.this);
                                        ...
                                        builder.setItems(priceItem, new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialogInterface, int which) {
                                                ...
                                                if(which == 0){
                                                    ...
                                                    AlertDialog.Builder builder3 = new AlertDialog.Builder(Tab19.this);
                                                    builder3.setTitle("How much price that you buy ?");
                                                    final EditText input = new EditText(Tab19.this);
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        AlertDialog.Builder builder5 = new AlertDialog.Builder(Tab19.this);
