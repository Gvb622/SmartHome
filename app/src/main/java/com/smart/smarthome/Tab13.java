...
public class Tab13 extends AppCompatActivity {
        ...
        mList.addOnItemTouchListener(
                new RecyclerItemClickListener(getApplicationContext(), mList, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(Tab13.this);
                        builder.setTitle("How many quantity ?");
                        final EditText input = new EditText(Tab13.this);
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                s.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        ...
                                        Toast.makeText(Tab13.this, item.getName() + " already add to shoppinglist", Toast.LENGTH_LONG).show();
