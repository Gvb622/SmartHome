    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                pType.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(Tab7.this);
        ...
        AddItem2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ShoppinglistShowlistActivity.remove = false;
                RemoveItem.setImageResource(R.mipmap.ic_clear_black_24dp);
                Intent intent5 = new Intent(Tab7.this, MainActivity.class);
            ...
            public void onClick(View v) {
                ...
                pType.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        AlertDialog.Builder builder2 = new AlertDialog.Builder(Tab7.this);
                        builder2.setTitle("Choose Shop that You buy");
                        builder2.setItems(priceItem, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int which) {
                                if(which == 0){
                                    AlertDialog.Builder builder3 = new AlertDialog.Builder(Tab7.this);
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (ShoppinglistShowlistActivity.remove == true) {
                            ...
                            AlertDialog.Builder builder5 = new AlertDialog.Builder(Tab7.this);
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                User.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(final DataSnapshot dataSnapshot) {
                                        ...
                                        final AlertDialog.Builder builder = new AlertDialog.Builder(Tab7.this);
                                        ...
                                        builder.setItems(priceItem, new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialogInterface, int which) {
                                                ...
                                                if (which == 0) {
                                                    ...
                                                    Toast.makeText(Tab7.this, i.getName() + " Already add to inventory ", Toast.LENGTH_LONG).show();
                                                    ...
                                                    builder2.setItems(priceItem, new DialogInterface.OnClickListener() {
                                                        ...
                                                        public void onClick(DialogInterface dialogInterface, int which2) {
                                                            if (which2 == 0) {
                                                                ...
                                                                final EditText input = new EditText(Tab7.this);
                    ...
                    public boolean onItemClick(View view, int position) {
                        ...
                        if (ShoppinglistShowlistActivity.remove == true) {
                            ...
                            s.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    Shoplistitem Shopitem = dataSnapshot.getValue(Shoplistitem.class);
                                    final AlertDialog.Builder builder2 = new AlertDialog.Builder(Tab7.this);
                                    //TextView title = new TextView(Tab7.this);
